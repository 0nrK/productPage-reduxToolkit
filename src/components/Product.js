...
const Product = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className="relative shadow-lg transition ease-out duration-800 ease-in">
                {images.map((image, index) => (

                    <div className={index === activeImg ? "flex flex-row w-100" : "hidden"} key={index}>
                        <img className="object-cover" src={image.src} alt="productImg" />
                        <div className="absolute top-1/2  w-full flex flex-row justify-between" >
            ...
            <div className="p-5 space-y-3">
                ...
                <p className="text-gray-500">These low-profile sneakers are your perfect casual wear companion. Featuring a durable rubber outer role. they'll withstand everything the weather can offer</p>
            </div>
            ...
            <div className="p-5">
                <div className=" flex bg-blue-50  rounded-lg items-center justify-between  flex-row p-3">
            ...
            <div className="p-5 ">
                <div className="flex shadow-xl rounded-md flex-row p-3 items-center justify-center space-x-3 bg-orange-500 hover:bg-orange-600">
                    ...
                    <button className="text-white text-xl ">Add to cart</button>
                </div>
            </div>
        </div>
    )
